...
impl CppMemoryDetail for NativeType {
    ...
    fn serializer_typename(&self) -> String {
        match self {
            ...
            NativeType::NoSwapU8 => "abf::NativeNoSwapSerializer<uint8_t, 1>".into(),
            NativeType::NoSwapU16 => "abf::NativeNoSwapSerializer<uint16_t, 2>".into(),
            NativeType::NoSwapU24 => "abf::NativeNoSwapSerializer<uint32_t, 3>".into(),
            NativeType::NoSwapU32 => "abf::NativeNoSwapSerializer<uint32_t, 4>".into(),
            NativeType::NoSwapU64 => "abf::NativeNoSwapSerializer<uint64_t, 8>".into(),
    ...
    fn deserializer_typename(&self) -> String {
        match self {
            ...
            NativeType::NoSwapU8 => "abf::NativeNoSwapDeserializer<uint8_t, 1>".into(),
            NativeType::NoSwapU16 => "abf::NativeNoSwapDeserializer<uint16_t, 2>".into(),
            NativeType::NoSwapU24 => "abf::NativeNoSwapDeserializer<uint32_t, 3>".into(),
            NativeType::NoSwapU32 => "abf::NativeNoSwapDeserializer<uint32_t, 4>".into(),
            NativeType::NoSwapU64 => "abf::NativeNoSwapDeserializer<uint64_t, 8>".into(),
